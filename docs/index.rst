...
- GOTTCHA2 database `(gottcha2/)`_ 
    
    The database `RefSeq-r90.cg.BacteriaArchaeaViruses.species.fna` is built by complete genomes of bacteria, archaea and viruses from RefSeq Release 90.

- Kraken2 database `(kraken2/)`_ 

    This is a standard Kraken 2 database, built by NCBI RefSeq genomes using following command:

.. code-block:: bash    

    kraken2-build --standard --threads 24 --db $DBNAME

- Centrifuge database `(centrifuge/)`_ 
